...
/* @ngInject */
angular.module('at.multirange-slider').directive('slider', ['$parse', '$compile', function ($parse, $compile) {
    return {
        restrict: 'E',
        replace: true,
        transclude: true,
...
}]).directive('sliderRange', ['$parse', function ($parse) {
    return {
...
}]).directive('sliderHandle', ['$document', function ($document) {
    return {
        replace: false,
        restrict: 'AC',
        require: ['^slider', '^sliderRange'],
